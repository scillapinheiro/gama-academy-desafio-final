    ...
    return (
        ...
        <div className="backgroundFaq">
            ...
            <div className="duvidaLink">
                ...
                <a className="button-fale-conosco" href="https://wa.me/52999723358?text=Olá!%20Tenho%20uma%20dúvida." target="_blank"><img src={Whatsapp} alt="Whatsapp logo" />Fale conosco</a> </div>
            </div>
        </>
    );
}
